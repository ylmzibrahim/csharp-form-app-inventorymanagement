...
{
    public partial class frmEnAzSatanlar : Form
    {
        public frmEnAzSatanlar()
        {
            InitializeComponent();
        }
        ...
        private void excelYazdir()
        {
            ...
            try
            {
                workbook.SaveAs("En Az Satanlar (" + DateTime.Today.ToString("yyyy.MM.dd") + ").xlsx");
            }
            catch (Exception)
            {
            }
